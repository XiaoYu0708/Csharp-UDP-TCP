...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        //開啟Server:用Server Thread 來監聽Client
        ...
        private void Listen()
        {
            ...
            {
                try                     //用Sck來接受此客戶的訊息，inLen是接收訊息的byte數目
                {
