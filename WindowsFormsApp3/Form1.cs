...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string IP = textBox1.Text; //伺服器 IP
            int Port = int.Parse(textBox2.Text); //伺服器 Port
            ...
            try
            {
                T.Connect(EP); //連上伺服器的端點 EP(類似撥號給電話總機)
        ...
        {
            byte[] B = Encoding.Default.GetBytes(Str);//翻譯字串 Str 為 Byte 陣列 B
